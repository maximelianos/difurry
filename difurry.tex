...
\small{Семинарист \bfend Елена Александровна Павельева $\heartsuit$\\
...
Допустим кратность $\lambda$ равна $3$\\
 $\mat{Y} = (\mat{a}t^2 + \mat{\beta}t + \mat{\newgamma}) e^{\lambda t} \infers \mat{Y}' = 2\mat{\alpha}t + \mat{\beta}$, $A\mat{Y} = A\mat{\alpha}t^2 + A\mat{\beta}t + A\mat{\newgamma}$\\
 $\mat{Y}' = A\mat{Y} \infers \left\{ \begin{aligned}
A\mat{\alpha} &= \mat{0}\\
A\mat{\beta} &= 2\mat{\alpha}\\
A\mat{\newgamma} &= \mat{\beta}\\
\end{aligned} \right. \infers A^3\mat{\newgamma} = \mat{0} \infers\ldots$\\
Так находим все решения \bfend наборы $\{\mat{\alpha}, \mat{\beta}, \mat{\newgamma}\}$.\\


Общее решение однородного уравнения\\
$\mat{Y}_{\text{одн}} = c_1 \mat{\alpha}_1 e^{\lambda_1} + \ldots + c_n \mat{\alpha}_n e^{\lambda_n}\quad \forall c_1,\ldots c_n$\\
