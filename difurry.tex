...
\small{Это \bfend шпаргалка, не учебник. Учебник \bfend Филиппов\\
...
\parbox[t][]{\htext}{$\mat{F}$ \bfend сумма специальных видов $\textinfers \mat{Y_\text{ч}} = \sum y_{\text{спец}}$ % Комментарии нужны??
}\vspace{0.5em}
